...
$smtp.Credentials = New-Object System.Net.NetworkCredential("meruemmitnick@outlook.com", "123Eagleeye456");
$smtp.EnableSsl = $true
$Message.From = "meruemmitnick@outlook.com"
$Message.To.Add("meruemmitnick@gmail.com")
